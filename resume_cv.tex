...
\name{Denys}{Smirnov}
\mobile{+380(66)253-4992}

\email{denys.o.smirnov@gmail.com}
% \homepage{www.posquit0.com}
\github{dendi239}
\linkedin{denys-smirnov}
%\skype{skypeid}
...
\makecvfooter{\today}{Denys Smirnov~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
